...
public class MyRedeemActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		quantityTextView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder alert = new AlertDialog.Builder(MyRedeemActivity.this);
				alert.setMessage("Please input the quantity number!");
				// Set an EditText view to get user input 
				final EditText input = new EditText(MyRedeemActivity.this);
	...
	public void redeem() {
		mProgressHUD = ProgressHUD.show( MyRedeemActivity.this, "", true, false, null);		
				...
				runOnUiThread( new Runnable() {
					...
					public void run() {
						...
						if (status_code.equalsIgnoreCase("0")) {
							AlertDialog.Builder builder = new AlertDialog.Builder(MyRedeemActivity.this);
